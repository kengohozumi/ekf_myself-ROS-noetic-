...
class GPSDataToxyz:
    def __init__(self):
        ...
        self.dev_name = "/dev/ttyUSB0"#"/dev/ttyUSB0" "/dev/ttyACM1"
        ...
        self.serial_baud = rospy.get_param("~baud", 115200)#UM928 115200 F9P 9600
    ...
    def get_gps(self, dev_name, country_id):
        ...
        if country_id == 0:   # Japan
            initial_letters = b"GNGGA"#f9p can not use
            #initial_letters = "GNGGA"#f9p can use
            #rospy.loginfo(initial_letters)
